...
This repository exists in the context of EGI Operations. While that scope does not
restrict the usage, it does inform the priority we assign to issues and the order we
deal with them. 
...
While we undertake to do everything in our power to respond to issues timeously, and to prioritise issues based on reasonable requests from submitters, the maintainers expect that the prioritisation of issues as decided by them is respected.
